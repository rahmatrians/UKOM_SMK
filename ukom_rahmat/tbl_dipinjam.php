<?php 
	...
	// membuat pagination
	$hitngTtlData 	= kueri("COUNT(*) AS ttl", "peminjaman WHERE status = '1' ");
	$fetchData 			= $hitngTtlData->fetch_array();
	$jmlData		= $fetchData['ttl'];
	$jmlPerhlmn		= 10;
	$rumusPage 		= ceil($jmlData / $jmlPerhlmn);
	$halmnAktif 	= (isset($_GET['hal_pi'])? $_GET['hal_pi']: "1");
...
<tbody>
	...
	<tr>
		<td><?= $row['id_pinjam'] ?></td>
		<td><a class='sidenav-trigger' data-target='tbl_pnj_<?= $row['id_akun'] ?>'><?= $row['nm_pengguna'] ?></a></td>
		<td><a class='sidenav-trigger' data-target='tbl_pnj_<?= $row['id_brg'] ?>'><?= $row['nm_brg'] ?></a></td>
		<td><?= $row['tgl_masuk'] ?></td>
...
<div id="tbl_pnj_<?= $row['id_akun'] ?>" class="sidenav r-detail-pmjm">
...
<div id="kondisi" class="sidenav r-detail-pmjm">
...
<div id="tbl_pnj_<?= $row['id_brg'] ?>" class="sidenav r-detail-pmjm">
	<div class="card-panel">
...
<?php if ($halmnAktif > 1) { ?>
 	...
 	<li class="waves-effect"><a href="?hal_pi=<?= $halmnAktif - 1 ?>"><i class="material-icons">chevron_left</i></a></li>
...
?>
 	...
 	<li class="active"><a href="?hal_pi=<?= $p ?>"><?= $p ?></a></li>

<?php
		else :
?>
 	<li class="waves-effect"><a href="?hal_pi=<?= $p ?>"><?= $p ?></a></li>
...
<?php if ($halmnAktif < $rumusPage) { ?>
 	...
 	<li class="waves-effect"><a href="?hal_pi=<?= $halmnAktif + 1 ?>"><i class="material-icons">chevron_right</i></a></li>
